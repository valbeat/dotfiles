...
name: cmux-markdown
description: >-
  Open markdown files in a formatted viewer panel with live reload.
  Use when user says "show markdown", "display plan", "open viewer",
  "プラン表示", "マークダウン開いて", or needs to display plans, documentation,
  or notes alongside the terminal with rich rendering.
allowed-tools: Bash
---
...
- If the file does not exist: report the path and suggest creating it first
- If the panel shows "file unavailable" after atomic replace: close and reopen with `cmux markdown open`
