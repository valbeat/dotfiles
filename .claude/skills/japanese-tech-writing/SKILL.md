...
本規範は散文向けであり、スライド制作では成果物の層で適用範囲を分ける。

- **全面適用**：自分向け記事（article.md）、CFP・プロポーザル本文、prep.md、outline.md、docs の解説文。
- **発表台本（script.md）・スピーカーノート**：論証・冗長・空句・記号の規範を適用するが、口語の自然さと聴衆への語りかけは、そのリポジトリの話し方ガイド（PRESENTATION_STYLE.md、MY_VOICE.md、SPEAKING.md 等）を優先する。
