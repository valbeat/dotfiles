...
name: cmux-browser
description: >-
  Browser automation inside cmux webviews — open sites, snapshot pages,
  interact with elements, and wait for state changes. Use when user says
  "open browser", "browse", "ブラウザ開いて", "snapshot page",
  "fill form", or needs to interact with web pages in cmux.
allowed-tools: Bash
---
...
Report that cmux CLI is not installed.
